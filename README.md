...
> **Caution: AI in use, quality unknown.** The per-project tags and
> summaries (see [AI tags and summaries](#ai-tags-and-summaries)) were
> generated by language models and have not been checked by a person. They
> can be wrong. The project data itself comes straight from Tiny Tapeout.
